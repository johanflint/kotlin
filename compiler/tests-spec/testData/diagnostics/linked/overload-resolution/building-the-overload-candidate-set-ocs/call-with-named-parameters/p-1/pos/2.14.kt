...
fun case1() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase1Explicit.listOf; typeCall: function")!>listOf(elements1= arrayOf(1))<!>
}
...
fun case2() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase2Explicit.listOf; typeCall: function")!>listOf(elements1= arrayOf(1))<!>
}
class A {
