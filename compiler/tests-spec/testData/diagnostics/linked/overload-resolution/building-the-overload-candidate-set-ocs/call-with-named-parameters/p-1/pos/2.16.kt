...
fun case1() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase1.listOf; typeCall: function")!>listOf(elements = arrayOf(1))<!>
}
// FILE: Lib.kt
...
fun case2() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase2.listOf; typeCall: function")!>listOf(elements = arrayOf(1))<!>
}
...
fun case3() {
    <!DEBUG_INFO_AS_CALL("fqName: testsCase3.A.invoke; typeCall: variable&invoke")!>listOf(elements = arrayOf(1))<!>
}
