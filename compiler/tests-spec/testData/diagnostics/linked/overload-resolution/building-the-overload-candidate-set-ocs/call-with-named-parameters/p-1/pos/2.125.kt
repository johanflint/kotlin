...
class Case1(){
    ...
    fun case() {
        <!DEBUG_INFO_AS_CALL("fqName: libPackageCase1.listOf; typeCall: extension function")!>listOf(elements1= arrayOf(1))<!>
    }
}
...
class Case2(){
    ...
    fun case() {
        <!DEBUG_INFO_AS_CALL("fqName: libPackageCase2.listOf; typeCall: extension function")!>listOf(elements1= arrayOf(1))<!>
    }
}
class A {
